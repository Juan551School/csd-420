...
public class RandomCardDisplay extends Application {
    ...
    private static final String CARD_PATH = "AssignmentCards"; // Folder where images are stored
    ...
    private void displayRandomCards() {
        ...
        // Fill the deck with numbers 1–52
        for (int i = 1; i <= 52; i++) {
            deck.add(i);
        }

        // Shuffle and select the first 4 cards
